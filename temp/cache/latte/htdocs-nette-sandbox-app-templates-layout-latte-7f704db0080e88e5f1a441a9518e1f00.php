<?php
// source: F:\xampp\htdocs\nette\sandbox\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6430738073', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb0295c29c14_head')) { function _lb0295c29c14_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbe919108db3_scripts')) { function _lbe919108db3_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
