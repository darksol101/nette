<?php
// source: F:\xampp\htdocs\net\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6754224558', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb161030222e_head')) { function _lb161030222e_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb667e16342b_scripts')) { function _lb667e16342b_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
