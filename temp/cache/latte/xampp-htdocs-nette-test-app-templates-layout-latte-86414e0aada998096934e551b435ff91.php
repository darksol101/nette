<?php
// source: F:\xampp\htdocs\nette-test\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7579842998', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbc4a4f70c8c_head')) { function _lbc4a4f70c8c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb8493bdac1b_scripts')) { function _lb8493bdac1b_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
