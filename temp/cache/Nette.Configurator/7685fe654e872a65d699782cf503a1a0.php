<?php
// source: F:\xampp\htdocs\nette-test\app/config/config.neon 
// source: F:\xampp\htdocs\nette-test\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'F:\\xampp\\htdocs\\nette-test\\app',
			'wwwDir' => 'F:\\xampp\\htdocs\\nette-test\\www',
			'debugMode' => TRUE,
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('F:\\xampp\\htdocs\\nette-test\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('F:\\xampp\\htdocs\\nette-test\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('F:\\xampp\\htdocs\\nette-test\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('F:\\xampp\\htdocs\\nette-test\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('F:\\xampp\\htdocs\\nette-test\\app/../temp/cache', $this->getService('nette.cacheJournal'));
